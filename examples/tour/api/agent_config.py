...
def build_shopping_config() -> ShoppingAgentConfig:
    ...
    return ShoppingAgentConfig(
        ...
        domain_search_notes=(
            ...
            "booked at, while market_adult_price is the 市场价 and belongs to the customer-facing "
            "share page alone — quote the advisor the 同业价. quote_source=list means only the "
