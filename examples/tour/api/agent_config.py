...
def build_shopping_config(*, live: bool = False) -> ShoppingAgentConfig:
    ...
    return ShoppingAgentConfig(
        ...
        domain_search_notes=(
            ...
            "when named; days_min/days_max when a length is given; no_shopping=yes when the "
            ...
            "东欧巴尔干, 意大利一地 …); price_max as a whole number of yuan when a ceiling on the "
            "起价 is given. destination is matched against a line's countries, its 线路系, its "
            ...
            "conversation has stated dates, every 线路 card already carries the sellable 团期 in "
            "its departures attribute (2026-10-03:可报名|2026-10-05:已成团|2026-10-08:满员) — read "
            "those dates off the card, and open present_departures when the advisor asks for the "
            "团期 themselves, for seats or for a price. "
