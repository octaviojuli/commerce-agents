...
def build_shopping_config() -> ShoppingAgentConfig:
    ...
    return ShoppingAgentConfig(
        ...
        domain_search_notes=(
            ...
            "and matches destination against route names, tags, 亮点, the selling department and the "
            "departure city, so a destination the catalog writes down nowhere finds nothing. "
            ...
            "shown is held. A departure carries two prices: adult_price and "
